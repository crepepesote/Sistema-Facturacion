  ...
  return (
    <div>
      ...
      <form onSubmit={handleAddOrUpdateProduct}>
        <input placeholder="Nombre del Producto" value={newProduct.nombre_pro} onChange={(e) => setNewProduct({ ...newProduct, nombre_pro: e.target.value })} required />
        <input placeholder="Descripción" value={newProduct.descripcion_pro} onChange={(e) => setNewProduct({ ...newProduct, descripcion_pro: e.target.value })} required />
        <select 
      ...
      <ul>
        {products.map(product => (
          <li key={product.id_producto}>
            {product.nombre_pro} - {product.descripcion_pro} ({product.unidad_pro})
